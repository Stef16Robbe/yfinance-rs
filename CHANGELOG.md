...
- Quote v7, options, search, and screener auth fallbacks now clear stale cached crumbs and reacquire credentials when a crumb-authenticated retry still returns 401/403.
